...
print("epoch_num,epoch_num,epoch_num",epoch_num)
image_ids = open('/home/kelvinng/桌面/VOCdevkit/VOC2007_h/ImageSets/Main/test.txt').read().strip().split()
...
for image_id in tqdm(image_ids):
    image_path = "/home/kelvinng/桌面/VOCdevkit/VOC2007_h/JPEGImages/"+image_id+".jpg"
